...
function attachEvents() {
  ...
  // Touch Events
  {
    if (!Support.touch && (Support.pointerEvents || Support.prefixedPointerEvents)) {
      ...
      _doc.addEventListener(touchEvents.move, swiper.onTouchMove, capture);
      _doc.addEventListener(touchEvents.end, swiper.onTouchEnd, false);
    } else {
      if (Support.touch) {
      ...
      if ((params.simulateTouch && !Device.ios && !Device.android) || (params.simulateTouch && !Support.touch && Device.ios)) {
        ...
        _doc.addEventListener('mousemove', swiper.onTouchMove, capture);
        _doc.addEventListener('mouseup', swiper.onTouchEnd, false);
      }
    }
